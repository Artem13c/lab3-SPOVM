...
void Server(char* path)
{
	...
	Semaphores[0] = CreateSemaphore(NULL, 0 , 1, "SEMAPHORE_lab3");      
	Semaphores[1] = CreateSemaphore(NULL, 0 , 1, "SEMAPHORE_end_lab3");     
	Semaphores[2] = CreateSemaphore(NULL, 0 , 1, "SEMAPHORE_EXIT_lab3");				
